  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <img src={markDataUri({ ring: "#E4E7EE", gold: GOLD_DARK })} width={300} height={300} alt="" />
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
          <div style={{ fontSize: 68, fontWeight: 600, letterSpacing: -1.5 }}>The Cognitive Mirror</div>
